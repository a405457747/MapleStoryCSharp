...
namespace MapleStory
{
    ...
    public class GuideCircleController : MonoBehaviour
    {
        ...
        public void ChangeTarget(RectTransform target)
        {
            ...
            //计算最终高亮显示区域的半径
            _radius = Vector2.Distance(WorldToCanvasPos(_canvas, _corners[0]), WorldToCanvasPos(_canvas, _corners[2])) /
                      2f;
            //计算高亮显示区域的圆心
            ...
            if (_canvasRectTransform != null)
            {
                ...
                foreach (var corner in _corners)
                    _currentRadius = Mathf.Max(Vector3.Distance(WorldToCanvasPos(_canvas, corner), center),
                        _currentRadius);
            }
